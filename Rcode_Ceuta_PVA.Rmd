...
---
```{r, echo = FALSE}
knitr::opts_chunk$set(collapse = TRUE, comment = "#>", cache = TRUE, warning = FALSE, fig.align='center')
```
...
* For running the complete code you need a `files` subfolder containing the raw data downloaded from `Data_files` folder provided in the  [GitHub](https://github.com/leberhartphillips/Ceuta_snowy_plover_PVA) repository.
...
## Vizualize annual variation in stage-specific survival
```{r, results="hide", message=FALSE, cache = TRUE, fig.height=6}
